...
| `publish-release.yml` | pending audit | infrastructure | release | pending audit | release ref | release artifacts | release success is not assurance PASS | release | `RETAIN-INFRASTRUCTURE` | Preserve release boundary; inspect duplicated validation commands only. |
