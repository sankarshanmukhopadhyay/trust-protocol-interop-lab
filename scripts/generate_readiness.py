...
out=['---','layout: default','title: Interoperability Readiness','---','# Interoperability Readiness','','Generated from the machine-readable case catalog.','','| Case | Status | Ownership | Invariants | + vectors | − vectors | Executed evidence |','|---|---|---:|---:|---:|---:|---:|']
